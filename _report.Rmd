...
```{r cache=TRUE, include=TRUE, warning=FALSE, message=FALSE}
#Specify which of the 3 you want (“regress”, “latent”, “covs”).
lplot <- lavaanPlot(model = fit_sem1, node_options = list(shape = "box", fontname = 
"Helvetica"), edge_options = list(color = "grey"), digits = 2, coefs = TRUE, covs = TRUE, stand = TRUE, stars = c("covs"))
embed_plot_pdf(lplot, 'sem_1.pdf')
lplot
